...
export const httpCreate = () => {
  ...
  instance.defaults.baseURL = '/api'; // 配置axios请求的地址
  // instance.defaults.headers.post['Content-Type'] = 'application/json; charset=utf-8';
  // instance.defaults.crossDomain = true;
  instance.defaults.withCredentials = true;  //设置cross跨域 并设置访问权限 允许跨域携带cookie信息
  //  常规配置项
  // instance.defaults.header['Content-Type'] = 'application/x-www-form-urlencoded';//  声明传给服务器的数据，通过请求传给服务器的数据application/x-www-form-urlencoded格式
...
export const httpCreateBlob = () => {
  ...
  let loadingInstance; //创建Loading 的实例
  instance.defaults.baseURL = 'http://7q33tz.natappfree.cc/libraryroom/'; // 配置axios请求的地址
  // instance.defaults.headers.post['Content-Type'] = 'application/json; charset=utf-8';
  instance.defaults.crossDomain = true;
  instance.defaults.withCredentials = true;  //设置cross跨域 并设置访问权限 允许跨域携带cookie信息
  instance.defaults.headers.common['Authorization'] = 'sss'; // 设置请求头为 Authorization
